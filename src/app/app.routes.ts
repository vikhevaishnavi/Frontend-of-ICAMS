...
export const routes: Routes = [
...

    {
        ...
        children: [
            ...
            { path: 'officer/accounts', loadComponent: () => import('./officer/account-management/account-management').then(m => m.AccountManagementComponent) },

            { path: 'officer/transactions', loadComponent: () => import('./officer/transaction-management/transaction-management').then(m => m.TransactionManagementComponent) },
